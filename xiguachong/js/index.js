  ...
  if(currentTab.html() == "推荐"){     // 推荐Tab 
    ...
    if($(".paihang ul").html() == "" || $(".paihang ul").html() == null){   
      ...
      $(".paihang ul").append(
        ...
        "<span>目标1500</span>" +
        "<span>已筹200</span><br/>" +
        "<span>倒计时:<div id='timer'></div></span>" +
        "</div>" +
...
//    var endDate=new Date(2015,10,16,17,30,30);//年月日时分秒，月要减去1
var endDate = (new Date()).getTime() + 10 * 24 * 60 * 60 * 1000;
(function daoJiShi() {
  var now = new Date();
